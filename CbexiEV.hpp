...
struct Conf {
    ...
    bool supported_ISO15118_20_AC;
    bool supported_ISO15118_20_DC;
    bool tls_active;
    bool enforce_tls;
    bool is_cert_install_needed;
};

class CbexiEV : public Everest::ModuleBase {
public:
    CbexiEV() = delete;
    CbexiEV(const ModuleInfo& info, Everest::MqttProvider& mqtt_provider, std::unique_ptr<ISO15118_evImplBase> p_ev,
            Conf& config) :
